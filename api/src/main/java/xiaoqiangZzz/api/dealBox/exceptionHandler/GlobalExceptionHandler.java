package xiaoqiangZzz.api.dealBox.exceptionHandler;
...
public class GlobalExceptionHandler {
   ...
   * @return 异常处理器
   */
  @ExceptionHandler(value = {com.mengyunzhi.core.exception.AccessDeniedException.class})
  ...
  public ResponseEntity<ErrorMessage> notAuthenticationExceptionHandler(
      HttpServletRequest request, Exception exception) {
    logger.error("非法参数异常: 主机 {} 调用地址 {} 错误信息 {}",
        request.getRemoteHost(), request.getRequestURL(), exception.getMessage());
