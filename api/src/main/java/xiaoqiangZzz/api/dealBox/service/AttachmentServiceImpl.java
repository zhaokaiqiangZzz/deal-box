...
import xiaoqiangZzz.api.dealBox.repository.FileRepository;
...
public class AttachmentServiceImpl implements AttachmentService {
  ...
  public AttachmentServiceImpl(FileRepository fileRepository,
  ...
  public Attachment saveAttachment(MultipartFile multipartFile, Path saveFilePath, Boolean useOriginNameSave) throws Exception {
    ...
    xiaoqiangZzz.api.dealBox.entity.File oldFile = this.fileRepository.findTopBySha1AndMd5(sha1ToMultipartFile, md5ToMultipartFile);
    // 判断是否保存file
    if (oldFile == null) {
      ...
      xiaoqiangZzz.api.dealBox.entity.File file = new xiaoqiangZzz.api.dealBox.entity.File();
